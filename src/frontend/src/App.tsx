    ...
    >
      ...
      >
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse at 20% 50%, oklch(0.72 0.18 185 / 0.08) 0%, transparent 70%)",
          }}
        />
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-xs text-muted-foreground leading-tight mt-0.5 truncate">
            Extract text from any PDF instantly — fast, free &amp;
            browser-based.
          </p>
        </div>
    ...
    <div className="flex justify-center mb-5">
      ...
      >
        <Activity
          className={cn(
            "w-3.5 h-3.5",
            limitReached ? "text-destructive" : "text-teal",
          )}
        />
        <span className="text-white/70">Daily Usage:</span>
        <span
