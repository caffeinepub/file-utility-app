...
export function SubscriptionPanel() {
  ...
  const isApprovedByVerification =
    verificationStatus === UTRVerificationStatus.approved;
  const isProUser =
    (isAuthenticated && isProFromBackend === true) || isApprovedByVerification;

  const isPending =
    verificationStatus === UTRVerificationStatus.pending || submitUTR.isSuccess;
    ...
    <div className="space-y-6">
      ...
      <div
        className={cn(
          ...
          isProUser ? "bg-teal/15 border-teal/40" : "bg-teal/10 border-teal/30",
        )}
      >
        <div
          className={cn(
        ...
        >
          ...
          <div className="flex-1">
            <p className="text-sm text-white/80">
              <span className="font-semibold text-violet">Log in</span> to save
              your subscription to your account
            </p>
            <p className="text-xs text-white/50 mt-0.5">
              Your Pro status and usage counter will sync across devices.
            </p>
          </div>
          <button
            type="button"
        ...
        >
          ...
          <div>
            ...
            <p className="text-xs text-white/60 mt-0.5">
              Enjoy unlimited conversions and all Pro features.
            </p>
          </div>
        </div>
      )}
        ...
        >
          ...
          <div>
            <p className="text-sm font-semibold text-amber-300">
              Payment Received. Verification in progress (usually 30 mins).
            </p>
            <p className="text-xs text-white/50 mt-0.5">
              We'll upgrade your account once the payment is confirmed.
            </p>
          </div>
        </div>
      )}
      ...
      {!isProUser && (
        ...
        >
          <p className="text-sm text-white/75 leading-relaxed">
            Enjoy <span className="text-teal font-semibold">4 free uses</span>{" "}
            every 24 hours. Upgrade to Pro for unlimited access for just{" "}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          >
            <div
              ...
              style={{
                background:
                  "radial-gradient(ellipse at 30% 20%, oklch(0.72 0.18 185 / 0.15) 0%, transparent 70%)",
              }}
            />
      ...
      {showStep2 && !isPending && !isProUser && (
        ...
        >
          <div
            ...
            style={{
              background:
                "radial-gradient(ellipse at 50% 0%, oklch(0.72 0.18 185 / 0.2) 0%, transparent 70%)",
            }}
          />
          ...
          <div className="relative space-y-5">
            <div>
              <h3 className="text-base font-semibold text-white mb-1 flex items-center gap-2">
                <span className="w-6 h-6 rounded-full bg-teal/20 border border-teal/40 text-teal text-xs font-bold flex items-center justify-center shrink-0">
                  2
                </span>
                Step 2: Enter your 12-digit UPI UTR/Transaction ID from the
                urpay receipt.
              </h3>
              <p className="text-xs text-white/50 ml-8">
                After completing payment, find the UTR/Transaction ID in your
                payment receipt.
              </p>
            </div>
              ...
              <input
                ...
                className={cn(
                  ...
                  emailError
                    ...
                    : "border-white/15 focus:border-teal/40",
                )}
              />
              {emailError && (
