...
import { useApproveUTR, useGetPendingVerifications } from "../hooks/useQueries";
      ...
      <div className="flex flex-col sm:flex-row sm:items-center gap-4">
        <div className="flex-1 min-w-0 space-y-1.5">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm font-mono text-teal tracking-widest">
              {submission.utrId}
            </span>
          </div>
...
export function AdminPanel() {
  ...
  const [approvingPrincipal, setApprovingPrincipal] = useState<string | null>(
    null,
  );
  const [approvedPrincipals, setApprovedPrincipals] = useState<Set<string>>(
    new Set(),
  );
        ...
        >
          ...
          <div className="flex-1">
            ...
            <p className="text-xs text-white/50 mt-0.5">
              Review and approve UPI payment submissions
            </p>
          </div>
          <button
            type="button"
