...
import { Eraser, Merge, ShieldCheck } from "lucide-react";
  ...
  return (
    <div className="space-y-5 animate-fade-in">
      ...
      <GlassCard className="p-5">
        ...
        {activeTool === "merger" && (
          <PDFMerger onLimitReached={onLimitReached} />
        )}
        {activeTool === "background" && (
          <BackgroundRemover onLimitReached={onLimitReached} />
        )}
        {activeTool === "metadata" && (
          <MetadataScrubber onLimitReached={onLimitReached} />
        )}
      </GlassCard>
    </div>
  );
