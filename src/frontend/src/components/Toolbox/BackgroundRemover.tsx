...
import { Download, Eraser, Eye, EyeOff, Loader2, Lock, X } from "lucide-react";
          ...
          <div className="relative rounded-xl overflow-hidden bg-[url('data:image/svg+xml;base64,')] border border-white/10 max-h-64 flex items-center justify-center">
            ...
            <div className="absolute top-2 right-2 flex gap-2">
              ...
              <button
                type="button"
                onClick={clearFile}
                className="p-1.5 rounded-lg bg-black/50 backdrop-blur-sm text-white/80 hover:text-white transition-all"
              >
          ...
          <div className="flex gap-2">
            ...
            {resultBlob && (
              <button
                ...
                className="btn-ghost-teal px-4 py-2.5 rounded-xl text-sm flex items-center gap-2"
              >
