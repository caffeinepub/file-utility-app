...
import { type ScrubResult, scrubMetadata } from "../../utils/metadataScrubber";
                ...
                >
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2">
                      ...
                      {result && (
                        <span className="badge-teal flex-shrink-0">Clean</span>
                      )}
                      {error && (
                    ...
                    <div className="text-xs text-muted-foreground mt-0.5">
                      ...
                      {result && (
                        <span className="text-teal ml-2">
                          ...
                          {result.removedFields.length > 3
                            ? ` +${result.removedFields.length - 3} more`
                            : ""}
                        </span>
                      )}
                    </div>
