        ...
        <div className="space-y-2">
          ...
          <div className="space-y-1.5 max-h-52 overflow-y-auto scrollbar-thin pr-1">
            {pdfFiles.map((file, idx) => (
              <div
                key={`${file.name}-${idx}`}
                className="file-item p-2.5 flex items-center gap-2"
              >
                <div className="flex flex-col gap-0.5">
                  ...
                  >
                    <svg
                      ...
                      viewBox="0 0 24 24"
                      stroke="currentColor"
                      aria-labelledby={`move-up-title-${idx}`}
                    >
                      <title id={`move-up-title-${idx}`}>Move up</title>
                      <path
                        strokeLinecap="round"
                  ...
                  >
                    <svg
                      ...
                      viewBox="0 0 24 24"
                      stroke="currentColor"
                      aria-labelledby={`move-down-title-${idx}`}
                    >
                      <title id={`move-down-title-${idx}`}>Move down</title>
                      <path
                        strokeLinecap="round"
                        strokeLinejoin="round"
                        strokeWidth={2}
