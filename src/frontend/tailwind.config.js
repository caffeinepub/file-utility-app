        ...
        extend: {
            ...
            colors: {
                ...
                teal: {
                    ...
                    light: 'oklch(0.82 0.14 175)',
                    dark: 'oklch(0.55 0.18 175)',
                },
                violet: {
                    DEFAULT: 'oklch(0.65 0.20 300)',
                    light: 'oklch(0.75 0.16 300)',
                    dark: 'oklch(0.50 0.20 300)',
                },
                chart: {
                    1: 'oklch(var(--chart-1))',
                    2: 'oklch(var(--chart-2))',
            ...
            keyframes: {
                ...
                'pulse-glow': {
                    ...
                    '50%': { boxShadow: '0 0 30px rgba(45, 212, 191, 0.5)' },
                },
                'fade-in': {
